      ...
      <div className="relative z-10 ~px-[1.5rem]/[4.5rem] ~pt-[2rem]/[3.5rem] ~pb-[1rem]/[3rem]">
        <div className="flex flex-col items-center md:items-end">
          <div className="md:flex-row flex flex-col-reverse md:justify-between mb-[2rem] w-full">
            <div className="text-white font-serif  flex flex-col  ~text-h3/h2 ~leading-[1.5rem]/[2.5rem]">
             <Link href={"tel:+35699936017"}> +35699936017 </Link>

             <Link href={"mailto:Info@malbrizventuresltd.com"}> Info@malbrizventuresltd.com</Link>
            </div>
