...
const About = () => {
  return (
    <div className=" h-screen md:h-[60vh] relative">
      ...
      />
      <div>
        <div className="absolute top-0 left-0 w-full h-full flex flex-col justify-center items-center text-center px-[1.15rem]">
          <WordStaggerAnimation
            text="About Malbriz Ventures"
            className="~text-h2/h7 font-bold text-[#0B2A67] mb-4 "
            duration={1.1}
         ...
         With a commitment to cleanliness, customer satisfaction, and convenience, we strive to make every shopping experience seamless and enjoyable. Whether you are shopping for a quick dinner, stocking up on household essentials, or exploring new products, Malbriz Ventures is here to serve you better — every day.`}
            className="~text-h3/h2 ~leading-[1.5rem]/[2.5rem]  max-w-5xl mb-4 "
          />
          <Link href={"/about"}>
            <button className="bg-[#0B2A67] hover:bg-[#0b2457] text-white font-semibold text-h3 rounded-[1rem] px-[1.5rem] py-[0.5rem] shadow-md transition mt-[2rem]">
              Know More
            </button>
          </Link>
        </div>
