            ...
            <div>
              <WordStaggerAnimation
                text=" Need help or more info? 
                             Reach out now!"
                className="~text-h2/h7 leading-[2rem] font-bold text-[#0B2A67]  mb-4"
                duration={1.1}
                staggerChildren={0.25}
              />

              <Link href={"/contact"}>
                <button className="text-white bg-[#0B2A67] font-semibold ~text-h8/h3 rounded-[1rem] ~px-[1rem]/[1.5rem] py-[0.5rem] shadow-md transition ~mt-[1rem]/[2rem]">
                  Contact Us
                </button>
              </Link>
            </div>
